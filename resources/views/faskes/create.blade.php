    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('faskes.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div
                ...
                <div>
                    ...
                    @foreach ($jenisFaskes as $jenis)
                        ...
                        {{ old('jenis_faskes_id') == $jenis->id ? 'selected' : '' }}>
                        {{ $jenis->nama }}
                        </option>
                    @endforeach
                    </select>
                ...
                <div>
                    ...
                    @foreach ($kabkota->groupBy('provinsi.nama') as $provinsiNama => $kabkotaList)
                        ...
                        @foreach ($kabkotaList as $kab)
                            <option value="{{ $kab->id }}"
                            {{ old('kabkota_id') == $kab->id ? 'selected' : '' }}>
                            {{ $kab->nama }}
                            </option>
                        @endforeach
                        </optgroup>
            ...
            <div
                ...
                <button type="submit"
                    class="flex-1 inline-flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium">
                    <i class="fas fa-save mr-2"></i>
                    Simpan Faskes
                </button>

                <a href="{{ route('faskes.index') }}"
                    class="flex-1 inline-flex items-center justify-center px-4 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200 font-medium">
