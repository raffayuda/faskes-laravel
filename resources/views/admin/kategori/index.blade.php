...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-6 border-b border-gray-200 dark:border-gray-700">
        <div>
            <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Data Kategori</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Kelola data kategori fasilitas kesehatan</p>
        </div>
                    ...
                    <tr>
                        <td colspan="3" class="px-6 py-12 text-center">
                            <div class="text-gray-500 dark:text-gray-400">
                                ...
                                <p class="mt-1">Silakan tambah data kategori baru</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
