...
@section('title', 'Tambah Jenis Faskes')
@section('page-title', 'Tambah Jenis Faskes')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Tambah Jenis Faskes Baru</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Isi form untuk menambah jenis faskes baru</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('jenis-faskes.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
