            ...
            <nav class="mt-8">
                <div class="px-4 space-y-2">
                    ...
                    <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <a href="#" 
                           class="flex items-center px-4 py-2 mt-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
